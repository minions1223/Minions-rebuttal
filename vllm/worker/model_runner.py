...
class ModelRunner:
    ...
    def _prepare_decode(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            seq_data = seq_group_metadata.seq_data[seq_id]
            seq_tokens = seq_data.get_token_ids()
            num_new_tokens = seq_data.num_new_tokens
            seq_len = seq_data.get_len()

            for i in range(seq_len - num_new_tokens, seq_len):
                new_token = seq_tokens[i]
                ...
                if self.sliding_window is not None:
                    ...
                    raise ValueError("not yet support sliding_window")
    ...
    def execute_model(
        ...
        # print('slot mapping: ', input_metadata.slot_mapping)
        # print('block_tables: ', input_metadata.block_tables)
